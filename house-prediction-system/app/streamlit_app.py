...
if st.button(
    ...
    if first_flr_sf + second_flr_sf > gr_liv_area:
        st.error("1st Floor Area + 2nd Floor Area cannot be greater than Total Living Area")
        st.stop()

    if year_built > 2026:
        st.error("Year Built cannot be in the future.")
        st.stop()
            ...
            st.markdown(
                ...
                ">
                    ...
                    <p style="font-size: 16px;">
                        Prediction generated by our XGBoost application model
                    </p>
                </div>
                """,
